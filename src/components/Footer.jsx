      ...
      <div className="footer-container">
        ...
        <div className="footer-social">
          ...
          <div className="social-icons">
            <a href="https://www.instagram.com/bazarganitatari" className="social-icon" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://wa.me/<+989112761050>" className="social-icon" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://t.me/@Tatari1050" className="social-icon" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
